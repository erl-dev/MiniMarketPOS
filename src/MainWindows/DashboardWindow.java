...
public class DashboardWindow extends JFrame {
	...
	private Image imgUsersIcon = new ImageIcon(this.getClass().getResource("/teamwork.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH);
	...
	private PanelUsers panelUsersPage;
	private PanelReceiving panelReceivingPage;
	private PanelReports panelReportsPage;
	...
	public DashboardWindow() {
		...
		panelUsersPage = new PanelUsers();
		panelReceivingPage = new PanelReceiving();
		panelReportsPage = new PanelReports();
		...
		panelUsers.addMouseListener(new PanelButtonMouseAdapter(panelUsers) {
			@Override
			public void mouseClicked(MouseEvent e) {
				menuClicked(panelUsersPage);
			}
		});
		panelUsers.setBackground(new Color(0, 139, 139));
		panelUsers.setBounds(0, 198, 384, 62);	
		panelMenu.add(panelUsers);
		panelUsers.setLayout(null);
		
		JLabel lblUsers = new JLabel("USERS");
		lblUsers.setForeground(Color.WHITE);
		lblUsers.setFont(new Font("Dialog", Font.BOLD, 20));
		lblUsers.setBounds(129, 11, 218, 40);
		...
		lblSalesIcon.setIcon(new ImageIcon(imgUsersIcon));
		panelUsers.add(lblSalesIcon);
	    ...
	    panelMain.add(panelUsersPage, "Users");
		panelMain.add(panelReceivingPage, "Receiving");
		panelMain.add(panelReportsPage, "Reports");
	...
	public void menuClicked(JPanel panel){
		...
		panelUsersPage.setVisible(false);
		panelReceivingPage.setVisible(false);
		panelReportsPage.setVisible(false);
